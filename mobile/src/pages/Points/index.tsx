...
const Points = () => {
  ...
  useEffect(() => {
   async function loadPosition() {
     ...
     // Getting your current position on the map
  ...
  useEffect(() => {
      // console.log(`********************** ACIMA DE ROUTE PARAMS`);
  ...
  const extractCoordinates = (point: Point) => {
    debugger
  ...
  return (
    <>     
      <View style={styles.container}>
        ...
        <Text style={styles.description}>Encontre no mapa pontos de coleta.</Text>      
            ...
            <MapView style={styles.map} 
              ...
              {points.map(point => (
                <Marker 
                  ...
                  coordinate={extractCoordinates(point)} >
